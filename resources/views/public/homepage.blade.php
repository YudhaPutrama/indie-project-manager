...
@section('content')
		...
		<ul class="slides">
			<li class="overlay image-bg">
				...
				<div class="container v-align-transform">
					<div class="row">
						<div class="col-md-6 col-sm-8">
							<h1 class="mb40 mb-xs-16 large">Slider 1</h1>
							<h6 class="uppercase mb16">Subtitle 1</h6>
							<p class="lead mb40">
				...
				<div class="container v-align-transform">
					<div class="row">
						<div class="col-md-6 col-sm-8">
							<h1 class="mb40 mb-xs-16 large">Slider 2</h1>
							<h6 class="uppercase mb16">Subtitle 2</h6>
							<p class="lead mb40">
				...
				<div class="container v-align-transform">
					<div class="row">
						<div class="col-md-6 col-sm-8">
							<h1 class="mb40 mb-xs-16 large">Slider 3</h1>
							<h6 class="uppercase mb16">Subtitle 3</h6>
							<p class="lead mb40">
								Build beautiful, contemporary sites in just moments
								<br>with Foundry and Variant Page Builder.
							</p>
	...
	</section><a id="yearbook" class="in-page-link"></a>
	...
	</section><a id="weeding" class="in-page-link"></a>
	...
	</section><a id="wisuda" class="in-page-link"></a>
	<section class="image-square left">
		<div class="col-md-6 image">
			<div class="background-image-holder">
				<img alt="image" class="background-image" src="img/small1.jpg">
	...
	</section><a id="portfolio" class="in-page-link"></a>
